...
namespace odb
{
  ...
  //
  template <typename A>
  struct pointer_query_columns< ::event, id_mysql, A >
  {
    // event_id
    //
    typedef
  ...
  template <typename A>
  const typename pointer_query_columns< ::event, id_mysql, A >::event_id_type_
  pointer_query_columns< ::event, id_mysql, A >::
  event_id (A::table_name, "`event_id`", 0);

  template <typename A>
  const typename pointer_query_columns< ::event, id_mysql, A >::event_name_type_
  pointer_query_columns< ::event, id_mysql, A >::
  event_name (A::table_name, "`event_name`", 0);

  template <typename A>
  const typename pointer_query_columns< ::event, id_mysql, A >::submit_date_type_
  pointer_query_columns< ::event, id_mysql, A >::
  ...
  template <typename A>
  const typename pointer_query_columns< ::event, id_mysql, A >::submitter_id_type_
  pointer_query_columns< ::event, id_mysql, A >::
  submitter_id (A::table_name, "`submitter_id`", 0);

  template <>
  class access::object_traits_impl< ::event, id_mysql >:
  ...
  class access::object_traits_impl< ::event, id_common >:
    public access::object_traits_impl< ::event, id_mysql >
  {
  };
  ...
  template <>
  struct query_columns_base< ::event, id_mysql >
  {
    // submitter_id
    //
    typedef
  ...
  template <typename A>
  struct query_columns< ::event, id_mysql, A >:
    query_columns_base< ::event, id_mysql >
  {
    // event_id
    //
    typedef
  ...
  template <typename A>
  const typename query_columns< ::event, id_mysql, A >::event_id_type_
  query_columns< ::event, id_mysql, A >::
  event_id (A::table_name, "`event_id`", 0);

  template <typename A>
  const typename query_columns< ::event, id_mysql, A >::event_name_type_
  query_columns< ::event, id_mysql, A >::
  event_name (A::table_name, "`event_name`", 0);
  ...
  template <typename A>
  const typename query_columns< ::event, id_mysql, A >::submitter_id_type_
  query_columns< ::event, id_mysql, A >::
  submitter_id (A::table_name, "`submitter_id`", 0);
}
