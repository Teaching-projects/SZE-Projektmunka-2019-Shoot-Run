...
namespace odb
{
  ...
  struct access::object_traits_impl< ::odbevent, id_mysql >::extra_statement_cache_type
  {
  ...
  const char access::object_traits_impl< ::odbevent, id_mysql >::tracks_traits::
  select_statement[] =
  "SELECT "
  "`track`.`track_id` "
  "FROM `track` "
  ...
  void access::object_traits_impl< ::odbevent, id_mysql >::tracks_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::odbevent, id_mysql >::tracks_traits::
  ...
  const char access::object_traits_impl< ::odbevent, id_mysql >::images_traits::
  select_statement[] =
  "SELECT "
  "`image`.`image_id` "
  "FROM `image` "
  ...
  void access::object_traits_impl< ::odbevent, id_mysql >::images_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        data_image_type& d)
  ...
  bool access::object_traits_impl< ::odbevent, id_mysql >::images_traits::
  select (index_type&, value_type& v, void* d)
  {
    using namespace mysql;
    using mysql::select_statement;
  ...
  access::object_traits_impl< ::odbevent, id_mysql >::id_type
  access::object_traits_impl< ::odbevent, id_mysql >::
  ...
  bool access::object_traits_impl< ::odbevent, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  const char access::object_traits_impl< ::odbevent, id_mysql >::persist_statement[] =
  "INSERT INTO `odbevent` "
  "(`event_id`, "
  "`event_name`, "
  "`submit_date`, "
  "`event_date`, "
  ...
  const char access::object_traits_impl< ::odbevent, id_mysql >::find_statement[] =
  "SELECT "
  "`odbevent`.`event_id`, "
  "`odbevent`.`event_name`, "
  "`odbevent`.`submit_date`, "
  "`odbevent`.`event_date`, "
  "`odbevent`.`event_accepted`, "
  "`odbevent`.`submitter_id` "
  "FROM `odbevent` "
  "WHERE `odbevent`.`event_id`=?";

  const char access::object_traits_impl< ::odbevent, id_mysql >::update_statement[] =
  "UPDATE `odbevent` "
  "SET "
  "`event_name`=?, "
  "`submit_date`=?, "
  ...
  const char access::object_traits_impl< ::odbevent, id_mysql >::erase_statement[] =
  "DELETE FROM `odbevent` "
  "WHERE `event_id`=?";

  const char access::object_traits_impl< ::odbevent, id_mysql >::query_statement[] =
  "SELECT\n"
  "`odbevent`.`event_id`,\n"
  "`odbevent`.`event_name`,\n"
  "`odbevent`.`submit_date`,\n"
  ...
  "`odbevent`.`submitter_id`\n"
  "FROM `odbevent`\n"
  "LEFT JOIN `user` AS `submitter_id` ON `submitter_id`.`user_id`=`odbevent`.`submitter_id`";

  const char access::object_traits_impl< ::odbevent, id_mysql >::erase_query_statement[] =
  "DELETE FROM `odbevent`";

  const char access::object_traits_impl< ::odbevent, id_mysql >::table_name[] =
  "`odbevent`";
  ...
  access::object_traits_impl< ::odbevent, id_mysql >::pointer_type
  access::object_traits_impl< ::odbevent, id_mysql >::
  ...
  result< access::object_traits_impl< ::odbevent, id_mysql >::object_type >
  access::object_traits_impl< ::odbevent, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::odbevent, id_mysql >::
